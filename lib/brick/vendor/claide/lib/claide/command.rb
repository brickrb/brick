...
require 'brick/vendor/claide/lib/claide/command/banner'
require 'brick/vendor/claide/lib/claide/command/plugin_manager'
require 'brick/vendor/claide/lib/claide/command/argument_suggester'
...
module Brick::CLAide
  ...
  class Command
    class << self
      ...
      # @return [Array<String>] The prefixes used t osearch for Brick::CLAide plugins.
    ...
    def self.root_command?
      superclass == Brick::CLAide::Command
    end
    ...
    #
    # @return [Brick::CLAide::Command, nil] The subcommand, if found.
    #
    ...
    # @raise  [Help]
    #
    #   Signals Brick::CLAide that a help banner for this command should be shown,
    ...
    # Brick::CLAide::Command::run, it does not load plugins nor exit on failure.
    ...
    #
    def run
      raise 'A subclass should override the `Brick::CLAide::Command#run` method to ' \
    ...
    def self.arguments_array=(arguments)
      warn '[!] The signature of Brick::CLAide#arguments has changed. ' \
        "Use Brick::CLAide::Argument (#{self}: `#{arguments}`)".ansi.yellow
