...
require 'brick/vendor/claide/lib/claide/ansi/cursor'
require 'brick/vendor/claide/lib/claide/ansi/graphics'
...
require 'brick/vendor/claide/lib/claide/ansi/string_escaper'
...
class String
  ...
  #
  def ansi
    Brick::CLAide::ANSI::StringEscaper.new(self)
  end
end
